...
class PAA.StudyGuide.Article.Figure extends AM.Quill.BlotComponent
  @id: -> 'PixelArtAcademy.StudyGuide.Article.Figure'
  @version: -> '0.1.0'
  ...
  class @Layout extends AM.DataInputComponent
    @register 'PixelArtAcademy.StudyGuide.Article.Figure.Layout'
    ...
    onCreated: ->
      ...
      @figureComponent = @ancestorComponentOfType PAA.StudyGuide.Article.Figure
  ...
  class @Caption extends AM.DataInputComponent
    @register 'PixelArtAcademy.StudyGuide.Article.Figure.Caption'
