...
class LM.Intro.Tutorial.Goals.PixelArtSoftware extends PAA.Learning.Goal
  ...
  class @DrawingApp extends PAA.Learning.Task.Automatic
    @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.DrawingApp'
    @goal: -> Goal
  ...
  class @DIY
    class @ChooseSoftware extends PAA.Learning.Task.Automatic
      @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.DIY.ChooseSoftware'
      @goal: -> Goal
    ...
    class @WatchTutorial extends PAA.Learning.Task.Manual
      @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.DIY.WatchTutorial'
      @goal: -> Goal
    ...
    class @Doodling extends PAA.Learning.Task.Upload
      @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.DIY.Doodling'
      @goal: -> Goal
    ...
    class @AdvancedTools extends PAA.Learning.Task.Upload
      @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.DIY.AdvancedTools'
      @goal: -> Goal
    ...
    class @Reference extends PAA.Learning.Task.Survey
      @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.DIY.Reference'
      @goal: -> Goal
    ...
    class @Grid extends PAA.Learning.Task.Upload
      @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.DIY.Grid'
      @goal: -> Goal
  ...
  class @GetReference extends PAA.Learning.Task.Automatic
    @id: -> 'PixelArtAcademy.LearnMode.Intro.Tutorial.Goals.PixelArtSoftware.GetReference'
    @goal: -> Goal
