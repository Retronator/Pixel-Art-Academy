...
class C1.PostPixelPad.Store extends LOI.Adventure.Scene
  @id: -> 'PixelArtAcademy.Season1.Episode1.Chapter1.PostPixelPad.Store'
  ...
  class @StoreListener extends LOI.Adventure.Listener
    ...
    @scriptUrls: -> [
      'retronator_pixelartacademy-season1-episode1/chapter1/sections/postpixelpad/scenes/store.script'
    ]
