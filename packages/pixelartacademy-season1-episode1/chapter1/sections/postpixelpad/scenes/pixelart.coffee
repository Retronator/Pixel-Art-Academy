...
class C1.PostPixelPad.PixelArt extends LOI.Adventure.Scene
  @id: -> 'PixelArtAcademy.Season1.Episode1.Chapter1.PostPixelPad.PixelArt'

  @location: -> HQ.Store

  @defaultScriptUrl: -> 'retronator_pixelartacademy-season1-episode1/chapter1/sections/postpixelpad/scenes/pixelart.script'
  ...
  onChoicePlaceholder: (choicePlaceholderResponse) ->
    ...
    # Prerequisite is that the player has talked about pixel art software while having the PixelPad.
    return unless HQ.Actors.Retro.Listener.Script.state 'HavePixelPad'

    labels = [
      'UsePixelPadEditorChoice'
    ...
    externalSoftware = PAA.PixelPad.Apps.Drawing.state 'externalSoftware'
    externalSoftwareName = PAA.PixelPad.Apps.Drawing.Portfolio.ExternalSoftware[externalSoftware]
    Tracker.nonreactive =>
