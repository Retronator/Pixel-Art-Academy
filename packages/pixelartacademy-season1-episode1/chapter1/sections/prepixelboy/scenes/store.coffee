...
class C1.PrePixelBoy.Store extends LOI.Adventure.Scene
  @id: -> 'PixelArtAcademy.Season1.Episode1.Chapter1.PrePixelBoy.Store'
  ...
  class @StoreListener extends LOI.Adventure.Listener
    ...
    @scriptUrls: -> [
      'retronator_pixelartacademy-season1-episode1/chapter1/sections/prepixelboy/scenes/store.script'
    ]
