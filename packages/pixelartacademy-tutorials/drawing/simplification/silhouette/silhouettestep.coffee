...
class PAA.Tutorials.Drawing.Simplification.Silhouette.SilhouetteStep extends PAA.Practice.Tutorials.Drawing.Assets.TutorialBitmap.PathStep
  constructor: ->
    super arguments...
    ...
    @_recreatePaths = Tracker.autorun => @_initializePaths()
  ...
  _initializePaths: ->
    return unless @_pathsDependency
    ...
    scene.traverse (object) ->
      meshes.push object if object instanceof THREE.Mesh
    ...
    for mesh in meshes
      ...
      pathElement.setAttribute 'style', 'opacity:1;fill:#000000;stroke:#000000;stroke-width:0.1;stroke-linecap:square;stroke-linejoin:bevel'
      
      @options.svgPaths.push pathElement
