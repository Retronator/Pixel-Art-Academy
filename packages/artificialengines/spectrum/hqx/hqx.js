 ...
 * 
 * Copyright (C) 2018 Matej Jan ( hi@retronator.com )
 *
...
var _Interp1 = function( pc, c1, c2 ) {
  if (!antialiasing) {_dest[pc] = c1; return;}
...
Artificial.Spectrum.Hqx._hqx = function( img, scale, useAntialiasing, trY, trU, trV ) {
  ...
  if (trY === undefined) trY = _trY;
  if (trU === undefined) trU = _trU;
  ...
  antialiasing = useAntialiasing === undefined ? true : useAntialiasing;
	...
	if( scale === 2 ) hq2x( img.width, img.height, trY, trU, trV );
	else if( scale === 3 ) hq3x( img.width, img.height, trY, trU, trV );
...
var hq2x = function( width, height, trY, trU, trV ) {
	var
		i, j, k,
		prevline, nextline,
		w = [],
...
var hq3x = function( width, height, trY, trU, trV ) {
	var
		i, j, k,
		prevline, nextline,
		w = [],
...
var hq4x = function( width, height, trY, trU, trV ) {
	var
		i, j, k,
		prevline, nextline,
		w = [],
