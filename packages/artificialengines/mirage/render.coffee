...
class AM.Render extends BlazeComponent
  ...
  renderContext: ->
    ...
    if component._blazeTemplate and not component.isDestroyed()
      throw new AE.InvalidOperationException "We're trying to include a rendered component that we're not a parent of." if component.isRendered() and @ isnt component.parentComponent()
