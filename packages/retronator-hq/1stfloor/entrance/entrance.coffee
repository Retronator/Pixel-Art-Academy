...
class HQ.Entrance extends LOI.Adventure.Location
  @id: -> 'Retronator.HQ.Entrance'
  ...
  things: -> [HQ.Entrance.Sign.id()]

  exits: ->
    exits = {}
    exits[Vocabulary.Keys.Directions.West] = HQ.Lobby.id()
    exits[Vocabulary.Keys.Directions.In] = HQ.Lobby.id()
