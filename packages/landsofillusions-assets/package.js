...
Package.onUse(function(api) {
  ...
  api.addFile('editor/helpers/enabled');
  ...
  api.addFile('mesheditor/tools/positioncharacterpreview');
  ...
  api.addFile('mesheditor/actions/lightshadowsenabled');
  api.addFile('mesheditor/actions/recomputemesh');
  api.addFile('mesheditor/actions/colorquantization');
  ...
  api.addFile('mesheditor/actions/lightsources');
  api.addFile('mesheditor/actions/lightvisibility');
  api.addFile('mesheditor/actions/restrictcolors');
  ...
  api.addFile('mesheditor/helpers/lightshadowsenabled');
  api.addFile('mesheditor/helpers/landmarks');
  api.addFile('mesheditor/helpers/colorquantization');
  api.addFile('mesheditor/helpers/characterpreview');
  api.addFile('mesheditor/helpers/lightsources');
  api.addFile('mesheditor/helpers/lightvisibility');
