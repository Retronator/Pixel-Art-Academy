...
class PAA.Practice.Challenges.Drawing.TutorialBitmap extends PAA.Practice.Project.Asset.Bitmap
  @id: -> 'PixelArtAcademy.Practice.Challenges.Drawing.TutorialBitmap'
