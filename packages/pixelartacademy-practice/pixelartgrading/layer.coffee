...
class PAG.Layer
  constructor: (@pixelArtGrading, @layerAddress) ->
    @pixels = []
    @pixelsMap = {}
    @cores = []
    @points = []
  ...
  updateArea: (bounds) ->
    ...
    bounds ?= @pixelArtGrading.bitmap.bounds
    ...
    for x in [bounds.x...bounds.x + bounds.width]
      for y in [bounds.y...bounds.y + bounds.height]
        ...
        bitmapPixel = @pixelArtGrading.bitmap.getPixelForLayerAtAbsoluteCoordinates @layerAddress, x, y
