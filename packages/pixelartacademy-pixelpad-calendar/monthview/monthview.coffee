...
class PAA.PixelPad.Apps.Calendar.MonthView extends AM.Component
  @id: -> 'PixelArtAcademy.PixelPad.Apps.Calendar.MonthView'
  @version: -> '0.1.0'
    ...
    @weeks = new ComputedField =>
      ...
      while date.getFullYear() < year or date.getMonth() <= month and date.getFullYear() <= year
        ...
        week.daysWithActivities =
          ...
          goal: PAA.PixelPad.Apps.Calendar.archivedWeeklyGoalsForDate(date)?.daysWithActivities
