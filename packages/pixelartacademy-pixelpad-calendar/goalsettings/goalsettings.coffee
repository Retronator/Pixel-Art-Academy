...
class PAA.PixelPad.Apps.Calendar.GoalSettings extends AM.Component
  @id: -> 'PixelArtAcademy.PixelPad.Apps.Calendar.GoalSettings'
  @version: -> '0.1.0'
  ...
  onClickConfirmButton: (event) ->
    ...
    if draftWeeklyGoals = @draftWeeklyGoals()
      unless draftWeeklyGoals.daysWithActivities is undefined
        PAA.PixelPad.Apps.Calendar.setDaysWithActivities draftWeeklyGoals.daysWithActivities

      unless draftWeeklyGoals.totalHours is undefined
        PAA.PixelPad.Apps.Calendar.setTotalHours draftWeeklyGoals.totalHours
  ...
  class @ActivityHoursPerWeek extends AM.DataInputComponent
    @register 'PixelArtAcademy.PixelPad.Apps.Calendar.GoalSettings.HoursPerWeek'
    ...
    onCreated: ->
      ...
      @goalSettings = @ancestorComponentOfType PAA.PixelPad.Apps.Calendar.GoalSettings
  ...
  class @ActivityHoursPerDay extends @ActivityHoursPerWeek
    @register 'PixelArtAcademy.PixelPad.Apps.Calendar.GoalSettings.HoursPerDay'
