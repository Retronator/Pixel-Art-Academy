...
class PAA.PixelPad.Apps.Drawing.Editor.Easel extends PAA.PixelPad.Apps.Drawing.Editor
  ...
  onCreated: ->
    ...
    viewsToolRequirements =
      "#{PAA.PixelPad.Apps.Drawing.Editor.Easel.ColorFill.id()}": PAA.Practice.Software.Tools.ToolKeys.ColorFill
  ...
  defaultInterfaceData: ->
    ...
    views = [
      type: FM.Menu.id()
      items: [
        PAA.PixelPad.Apps.Drawing.Editor.Easel.Actions.DisplayMode.id()
      ]
    ,
      type: PAA.PixelPad.Apps.Drawing.Editor.Easel.Frame.id()
      toolbox:
        type: FM.Toolbox.id()
        tools: []
    ,
