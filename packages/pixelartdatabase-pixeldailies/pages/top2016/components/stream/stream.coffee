...
class PADB.PixelDailies.Pages.Top2016.Components.Stream extends AM.Component
  @register 'PixelArtDatabase.PixelDailies.Pages.Top2016.Components.Stream'
  ...
  constructor: ->
    ...
    @infiniteScroll = new PADB.PixelDailies.Pages.Top2016.Components.Mixins.InfiniteScroll step: 10
  ...
  class @ArtworkCaption extends AM.Component
    @register 'PixelArtDatabase.PixelDailies.Pages.Top2016.Components.Stream.ArtworkCaption'
