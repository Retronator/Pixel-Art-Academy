  ...
  update: (materialProperties) ->
    ...
    for materialPropertiesEntry, materialIndex in materialProperties.getAll()
      if materialPropertiesEntry.paletteColor
        @_writeToData materialIndex, @constructor.propertyIndices.paletteColor, materialPropertiesEntry.paletteColor.ramp, materialPropertiesEntry.paletteColor.shade
