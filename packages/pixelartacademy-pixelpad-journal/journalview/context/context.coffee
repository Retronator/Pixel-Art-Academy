...
class PAA.PixelPad.Apps.Journal.JournalView.Context extends LOI.Memory.Context
  @id: -> 'PixelArtAcademy.PixelPad.Apps.Journal.JournalView.Context'
  @version: -> '0.1.0'
  ...
  onCreated: ->
    ...
    @journalDesign = new ComputedField =>
      ...
      Tracker.nonreactive =>
        ...
        new PAA.PixelPad.Apps.Journal.JournalView.JournalDesign[journalDocument.design.type]
          journalId: @options.journalId
  ...
  onRendered: ->
    ...
    @$context = @$('.pixelartacademy-pixelpad-apps-journal-journalview-context')
