...
class Entry.Object.Timestamp extends Entry.Object
  @id: -> 'PixelArtAcademy.PixelPad.Apps.Journal.JournalView.Entry.Object.Timestamp'
  @version: -> '0.1.0'
  ...
  @registerBlot
    name: 'timestamp'
    tag: 'p'
    class: 'pixelartacademy-pixelpad-apps-journal-journalview-entry-object-timestamp'
