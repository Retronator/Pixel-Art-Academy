...
class PAA.PixelPad.Apps.Journal.JournalView.Entry extends AM.Component
  @id: -> 'PixelArtAcademy.PixelPad.Apps.Journal.JournalView.Entry'
  @register @id()
  ...
  onRendered: ->
    ...
    @$entry = @$('.pixelartacademy-pixelpad-apps-journal-journalview-entry')
  ...
  events: ->
    super(arguments...).concat
      'scroll .pixelartacademy-pixelpad-apps-journal-journalview-entry': @onScrollEntry
