...
class PAA.PixelPad.Apps.Journal.JournalView.Tasks extends AM.Component
  @id: -> 'PixelArtAcademy.PixelPad.Apps.Journal.JournalView.Tasks'
  @version: -> '0.1.0'
  ...
  onCreated: ->
    ...
    @goals = new ComputedField =>
      return unless addedGoals = PAA.PixelPad.Apps.StudyPlan.state()?.goals
